...
export function Alert({alert,setAlert}:{
    ...
    return alert && alert.message && (
        <div className={`alert rounded-[10px] z-100  top-0 left-[50%] translate-x-[-50%] max-w-[1440px] m-auto fixed p-5 border w-full bg-[#FFFFFF] w-full text-white ${alert.type === "error" ? "bg-red-800" : "bg-green-600"}`}>
