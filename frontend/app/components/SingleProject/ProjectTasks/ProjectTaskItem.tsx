    ...
    return (
                <li className="pl-[40px] pr-[35px] py-[25px] border border-[#E5E7EB] bg-[#FFFFFF] rounded-[10px]">
                  <div className="flex items-start justify-between">
                    <div className="flex flex-col gap-[7px]">
                      <div className="flex gap-[8px]">
                        <h3 className="text-[18px] font-semibold text-[#000000]">Authentification JWT</h3>
                        <Tag type={"done"}/>
                      </div>
                      <p className="text-[#6B7280] text-[14px]">{"Implémenter le système d'authentification avec tokens JWT"}</p>
                    </div>
                      <div>
                  ...
                  <div className="flex justify-between items-center mt-[24px]">
                    <h4 className="text-[14px] text-[#1F1F1F]">Commentaires (1)</h4>
