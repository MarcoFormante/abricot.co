...
export function ModalContainer({children,setShowModal,showModale}:{
    children:React.ReactNode,
    setShowModal:React.Dispatch<React.SetStateAction<{type:string}>>,
    showModale:{type:string}
}){
    ...
    return (
        <div className="fixed w-full h-full top-0 left-0 z-10 flex justify-center items-center bg-[#5555558f]">
            <div className="w-[598px] h-[799px] bg-[#FFFFFF] rounded-[10px] px-[73px] pt-[79px] text-[#000000] relative">
                {children}
                 <button className="absolute top-[37.5px] right-[39.17px] cursor-pointer" onClick={onCloseModal}>
