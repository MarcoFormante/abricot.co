...
export function Project({project}:{project:ProjectInterface}) {
  ...
  return (
    <li className="border border-[#E5E7EB] h-[351px] overflow-hidden  rounded-[10px] px-[34px] py-[30px] bg-[#FFFFFF] w-[380px] max-[1370px]:w-[350px] max-[1280px]:w-[380px] max-lg:w-[350px] max-md:w-[80%] max-sm:w-full">
